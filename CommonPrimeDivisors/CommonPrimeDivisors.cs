...
namespace CommonPrimeDivisors
{
    class CommonPrimeDivisors
    {
        ...
        {
            Console.WriteLine(new Solution().solution(new int[] { 15, 10, 3 }, new int[] { 75, 30, 5 }));
        }
    }
    ...
    class Solution
    {
        ...
        private bool samePD(int N, int M) //Do Integers Contain Same Prime Divisors
        {
        ...
        private int gcd(int a, int b, int res) //Get Greatest Common Denominator Using Binary Euclidean Algorithm
        {
